...
if __name__ == '__main__':
    ...
    # ========================================================================
    # ✅ DÍA 6 - Configuración HTTPS para producción
    # ========================================================================
    ...
    if is_production:
        ...
        logger.info("=" * 70)
        logger.info("Flask corriendo detrás de proxy reverso (nginx)")
        logger.info(f"Dominio externo: https://sugipq.qualitascolombia.com.co/")
        logger.info(f"Puerto interno: {port} (solo localhost)")
        logger.info("Nginx maneja HTTPS en puerto 443")
        logger.info("=" * 70)
        
        # En producción, nginx maneja HTTPS
        # Flask solo escucha HTTP en puerto interno (seguro porque es localhost)
        app.run(
            debug=False,
        ...
        use_https = os.environ.get('USE_HTTPS_DEV', 'false').lower() == 'true'
        ...
        if use_https:
            try:
                ...
                logger.error("❌ Error: pyopenssl no instalado")
                logger.info("   Instalar con: pip install pyopenssl")
