        ...
        if success:
            ...
            if NOTIFICACIONES_ACTIVAS and solicitud_info and solicitud_info.get('email_solicitante'):
                try:
                    ...
                    logger.info(f"📧 Notificación enviada: Solicitud #{sanitizar_id(solicitud_id)} aprobada")
                except Exception as e:
        ...
        if success:
            ...
            if NOTIFICACIONES_ACTIVAS and solicitud_info and solicitud_info.get('email_solicitante'):
                try:
                    ...
                    logger.info(f"📧 Notificación enviada: Solicitud #{sanitizar_id(solicitud_id)} aprobada parcialmente")
                except Exception as e:
        ...
        if success:
            ...
            if NOTIFICACIONES_ACTIVAS and solicitud_info and solicitud_info.get('email_solicitante'):
                try:
                    ...
                    logger.info(f"📧 Notificación enviada: Solicitud #{sanitizar_id(solicitud_id)} rechazada")
                except Exception as e:
...
def solicitar_devolucion(solicitud_id):
    ...
    try:
        ...
        if success:
            logger.info(f'Devolución solicitada. Solicitud ID: {sanitizar_id(solicitud_id)}, Cantidad: {cantidad_devuelta}, Usuario: {sanitizar_username(usuario_solicita)}')
